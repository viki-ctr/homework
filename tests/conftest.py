...
def set_up():
    self_transactions = [
        {"operationAmount": {"currency": {"code": "EUR"}}, "currency_code": "EUR"},
        {"operationAmount": {"currency": {"code": "RUB"}}, "currency_code": "RUB"},
    ]
...
def transaction_2():
    return {
        ...
        "state": "EXECUTED",
        "date": "2019-08-26T10:50:58.294041",
        "operationAmounts": {"amount": "31957.58", "currency": {"name": "руб.", "code": "RUB"}},
        "description": "Перевод организации",
        "from": "Maestro 1596837868705199",
        "to": "Счет 64686473678894779589",
    }
